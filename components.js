...
header.innerHTML = `
    ...
    <ul class="nav-social">
        <li>
            <a href="https://github.com/Owen-3456" target="_blank" aria-label="GitHub Profile">
        ...
        <li>
            <a href="https://discord.com/users/374960413583998977" target="_blank" aria-label="Discord Profile">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li>
            <a href="https://steamcommunity.com/id/owen3456/" target="_blank" aria-label="Steam Profile">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li>
            <a href="https://wakatime.com/@Owen3456" target="_blank" aria-label="WakaTime Stats">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
