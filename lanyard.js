...
class LanyardManager {
    ...
    updateStatus(data) {
        ...
        this.updateStatusDisplay(statusColor, statusText);
    }
    ...
    getStatusText(status, activityStatus) {
        ...
        // you're kinda duplicating yourself considering the status color already informs the user of your status
    ...
    updateStatusDisplay(color, text) {
        this.statusContent.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          <path fill="${color}" d="M12 22q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22" />
        </svg>
